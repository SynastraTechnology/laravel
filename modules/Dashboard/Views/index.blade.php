            ...
            <div class="p-6 text-gray-900 dark:text-gray-100 flex items-center justify-between">
                ...
                <div>
                    <a href="{{ route('profile.edit') }}">
                        {{-- Pastikan Anda memiliki komponen <x-button> atau ganti dengan tag <a>/button biasa --}}
                        <button
                            class="px-4 py-2 bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-gray-200 rounded-md hover:bg-gray-300 dark:hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                            Edit Profil
                        </button>
                    </a>
                </div>
